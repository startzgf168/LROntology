...
public class SCORAgentFSM extends TimeoutSCORFSM{

	public SCORAgentFSM(String name) throws FSMException {
		super(name);
	...
	private final static BasicLogger logger = ConfigurationFSM.getLogger(SCORAgentFSM.class);
	
	public static void main(String args[]){
		// Create instance of the state machine
		try (StateMachine machine = new SCORAgentFSM(
				SCORAgentFSM.class.getSimpleName())) {
			...
			while (true) {				
				logger.info("Type a SCOR Event: [Source|Make|Deliver|Return] or Test Event:[Complete|Repair] to test the FSM over SCOR.");
