...
public class TimeoutSCORFSM extends TimeoutSynchNonDeterministicStateMachine{	
	/**
	 ...
	 */
	public TimeoutSCORFSM(String name) throws FSMException {
		super(name);
      ...
      //stateFailed = new State("Failed", State.Type.FINAL);
        ...
        //This is used to test the FSM currently
        stateDelivering_NullEvent_Condition8_stateIdle = new Transition(stateDelivering,SCOREvent.instance("Complete", TypeEvent.Type.COMPLETE),stateIdle);
...
//        addTransition(stateDelivering_NullEvent_Condition8_stateIdle);
        ...
        stateDelivering_NullEvent_Condition10_stateFailed = new Transition(stateDelivering,TimeoutEvent.instance(10000, TimeoutEvent.Type.LOOP_NO_RESTART),stateFailed);
        addTransition(stateDelivering_NullEvent_Condition10_stateFailed);
        
        //This is used to test the FSM currently
        stateFailed_NullEvent_Condition11_stateIdle = new Transition(stateFailed,SCOREvent.instance("Repair", TypeEvent.Type.REPAIR),stateIdle);
...
//        addTransition(stateFailed_NullEvent_Condition11_stateIdle);
        ...
        //This is used to test the FSM currently
        stateReturning_NullEvent_Condition12_stateIdle = new Transition(stateReturning,SCOREvent.instance("Complete", TypeEvent.Type.COMPLETE),stateIdle);
